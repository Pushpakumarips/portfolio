...
function Skills() {
  return (
    <main
      id="skills"
      className="md:px-[10%] px-[4%] lg:pt-[220px] pt-[150px] overflow-hidden"
    >
      ...
      <section
        className="flex md:flex-row flex-col justify-center mt-14 gap-[5rem]"
      ...
      >
        ...
        <div
          className="border rounded-xl w-full bg-card border-cardBorder"
